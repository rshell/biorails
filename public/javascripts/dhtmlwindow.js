...
var dhtmlwindow={
imagefiles:['/images/action/min.gif', '/images/action/close.gif', '/images/action/restore.gif', '/images/action/resize.gif'], //Path to 4 images used by script, in that order
