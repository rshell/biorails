...
#  public_role_id            :integer(11)   default(0), not null
#  session_timeout           :integer(11)   default(0), not null
#  default_markup_style_id   :integer(11)   default(0)
#  site_default_page_id      :integer(11)   default(0), not null
#  not_found_page_id         :integer(11)   default(0), not null
#  permission_denied_page_id :integer(11)   default(0), not null
#  session_expired_page_id   :integer(11)   default(0), not null
#  menu_depth                :integer(11)   default(0), not null
#
...
class SystemSettings < ActiveRecord::Base
  ...
  attr_accessor :site_default_page, :not_found_page, :permission_denied_page, :session_expired_page
  ...
  def default_markup_style
    if not @default_markup_style
      if self.default_markup_style_id
        ...
        @default_markup_style = MarkupStyle.new(:id => nil, :name => '(None)')
      end
    end
