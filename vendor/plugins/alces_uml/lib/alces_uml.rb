# AlcesUml
# 
# This provide a simple way to generate uml style models from a rails projects.
# 
module Alces
  module UmlModel
...
#
  def UmlModel.controllers
    logger.info "Reloading   UmlModel.controllers"
...
# 
# root Model to start at
# 
# options[:levels] how far to go with belongs_to styles
# options[:many] how far to go with has_many/has_ne styles
# options[:style] executable to call
# 
# 
