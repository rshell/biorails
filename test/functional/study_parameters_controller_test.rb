...
require 'study_parameters_controller'

# Re-raise errors caught by the controller.
class StudyParametersController; def rescue_action(e) raise e end; end

class StudyParametersControllerTest < Test::Unit::TestCase
