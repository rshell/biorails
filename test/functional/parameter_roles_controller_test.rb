...
require 'parameter_roles_controller'

# Re-raise errors caught by the controller.
class ParameterRolesController; def rescue_action(e) raise e end; end

class ParameterRolesControllerTest < Test::Unit::TestCase
