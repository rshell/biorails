...
class Project::ProjectsControllerTest < Test::Unit::TestCase
  # # fixtures :users # fixtures :roles # fixtures :role_permissions # fixtures
  # :permissions # fixtures :projects
  ...
  def test_get_gantt
    get :gantt,{:id=>@item.id}
    assert_response :success
  end

  def test_get_gantt_for_year_month
    get :gantt,{:id=>@item.id,:year=>2008,:month=>3}
    assert_response :success
  end

  def test_get_gantt_for_year
    get :gantt,{:id=>@item.id,:year=>2008}
    assert_response :success
  end
