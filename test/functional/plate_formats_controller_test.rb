...
require 'plate_formats_controller'

# Re-raise errors caught by the controller.
class PlateFormatsController; def rescue_action(e) raise e end; end

class PlateFormatsControllerTest < Test::Unit::TestCase
  fixtures :plate_formats

  def setup
    @controller = PlateFormatsController.new
