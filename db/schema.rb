...
ActiveRecord::Schema.define() do
  ...
  create_table "data_elements", :force => true do |t|
    ...
    t.column "content",            :text,     :limit => nil,                                 :default => "empty_clob()"
  ...
  create_table "memberships", :force => true do |t|
    ...
    t.column "is_owner",           :boolean,  :precision => 1,  :scale => 0, :default => false
    t.column "created_at",         :datetime,                                                   :null => false
    t.column "updated_at",         :datetime,                                                   :null => false
    t.column "updated_by_user_id", :integer,  :precision => 11, :scale => 0, :default => 1,     :null => false
    t.column "created_by_user_id", :integer,  :precision => 11, :scale => 0, :default => 1,     :null => false
  ...
  create_table "permissions", :force => true do |t|
    t.column "checked", :boolean, :precision => 1, :scale => 0, :default => false, :null => false
  ...
  create_table "project_assets", :force => true do |t|
    ...
    t.column "published",          :boolean,                 :precision => 1,  :scale => 0, :default => false
  ...
  create_table "report_columns", :force => true do |t|
    ...
    t.column "is_visible",         :boolean,                  :precision => 1,  :scale => 0, :default => true
    t.column "is_filterible",      :boolean,                  :precision => 1,  :scale => 0, :default => true
    t.column "is_sortable",        :boolean,                  :precision => 1,  :scale => 0, :default => true
  ...
  create_table "reports", :force => true do |t|
    ...
    t.column "updated_by_user_id", :integer,                  :precision => 11, :scale => 0, :default => 1,  :null => false
    t.column "created_by_user_id", :integer,                  :precision => 11, :scale => 0, :default => 1,  :null => false
    t.column "internal",           :boolean,                  :precision => 1,  :scale => 0
    t.column "project_id",         :integer,                  :precision => 11, :scale => 0
    t.column "action",             :string
  end
  ...
  create_table "request_services", :force => true do |t|
    t.column "request_id",           :integer,                  :precision => 11, :scale => 0,                 :null => false
    t.column "service_id",           :integer,                  :precision => 11, :scale => 0,                 :null => false
    t.column "name",                 :string,   :limit => 128,                                 :default => "", :null => false
    t.column "description",          :string,   :limit => 1024,                                :default => ""
    t.column "expected_at",          :datetime
    t.column "started_at",           :datetime
  ...
  create_table "roles", :force => true do |t|
    ...
    t.column "parent_id",          :integer,                  :precision => 11, :scale => 0
    t.column "description",        :string,   :limit => 1024,                                :default => "",             :null => false
    t.column "cache",              :text,     :limit => nil,                                 :default => "empty_clob()"
    t.column "created_at",         :datetime,                                                                            :null => false
    t.column "updated_at",         :datetime,                                                                            :null => false
    t.column "created_by_user_id", :integer,                  :precision => 11, :scale => 0, :default => 1,              :null => false
    t.column "updated_by_user_id", :integer,                  :precision => 11, :scale => 0, :default => 1,              :null => false
  ...
  create_table "sessions", :force => true do |t|
    ...
    t.column "data",            :text,     :limit => nil,                                 :default => "empty_clob()"
    t.column "created_at",      :datetime
    t.column "updated_at",      :datetime
  end
  ...
  create_table "study_logs", :force => true do |t|
    t.column "study_id",       :integer,                 :precision => 11, :scale => 0
    t.column "user_id",        :integer,                 :precision => 11, :scale => 0
    t.column "auditable_id",   :integer,                 :precision => 11, :scale => 0
    t.column "auditable_type", :string
    t.column "action",         :string
  ...
  create_table "study_parameters", :force => true do |t|
    t.column "parameter_type_id",  :integer,                 :precision => 11, :scale => 0,                 :null => false
    t.column "parameter_role_id",  :integer,                 :precision => 11, :scale => 0,                 :null => false
    t.column "study_id",           :integer,                 :precision => 11, :scale => 0, :default => 1
    t.column "name",               :string,                                                 :default => "", :null => false
    t.column "default_value",      :string
    t.column "data_element_id",    :integer,                 :precision => 11, :scale => 0
    t.column "data_type_id",       :integer,                 :precision => 11, :scale => 0,                 :null => false
  ...
  create_table "study_protocols", :force => true do |t|
    t.column "study_id",              :integer,                  :precision => 11, :scale => 0,                      :null => false
    t.column "study_stage_id",        :integer,                  :precision => 11, :scale => 0, :default => 1,       :null => false
    t.column "current_process_id",    :integer,                  :precision => 11, :scale => 0
    t.column "process_definition_id", :integer,                  :precision => 11, :scale => 0
  ...
  create_table "study_queues", :force => true do |t|
    ...
    t.column "description",         :string,   :limit => 1024,                                :default => "",       :null => false
    t.column "study_id",            :integer,                  :precision => 11, :scale => 0,                       :null => false
    t.column "study_stage_id",      :integer,                  :precision => 11, :scale => 0
    t.column "study_parameter_id",  :integer,                  :precision => 11, :scale => 0,                       :null => false
    t.column "study_protocol_id",   :integer,                  :precision => 11, :scale => 0
  ...
  create_table "taggings", :force => true do |t|
    t.column "tag_id",        :integer,  :precision => 11, :scale => 0
    t.column "taggable_id",   :integer,  :precision => 11, :scale => 0
  ...
  create_table "task_contexts", :force => true do |t|
    t.column "task_id",              :integer, :precision => 11, :scale => 0,                :null => false
    t.column "parameter_context_id", :integer, :precision => 11, :scale => 0,                :null => false
    t.column "label",                :string
    t.column "is_valid",             :boolean, :precision => 1,  :scale => 0
    t.column "row_no",               :integer, :precision => 11, :scale => 0,                :null => false
    t.column "parent_id",            :integer, :precision => 11, :scale => 0
    t.column "sequence_no",          :integer, :precision => 11, :scale => 0,                :null => false
    t.column "left_limit",           :integer, :precision => 11, :scale => 0, :default => 1
    t.column "right_limit",          :integer, :precision => 11, :scale => 0, :default => 2
  end
  ...
  create_table "task_references", :force => true do |t|
    t.column "task_context_id",    :integer,  :precision => 11, :scale => 0,                :null => false
    t.column "parameter_id",       :integer,  :precision => 11, :scale => 0,                :null => false
    t.column "data_element_id",    :integer,  :precision => 11, :scale => 0
    t.column "data_type",          :string,                                                 :null => false
    t.column "data_id",            :integer,  :precision => 11, :scale => 0,                :null => false
    t.column "data_name",          :string
    t.column "lock_version",       :integer,  :precision => 11, :scale => 0, :default => 0, :null => false
    t.column "created_at",         :datetime,                                               :null => false
    t.column "updated_at",         :datetime,                                               :null => false
  ...
  create_table "task_relations", :force => true do |t|
    t.column "to_task_id",   :integer, :precision => 11, :scale => 0
    t.column "from_task_id", :integer, :precision => 11, :scale => 0
    t.column "relation_id",  :integer, :precision => 11, :scale => 0
  end
  ...
  create_table "tasks", :force => true do |t|
    t.column "name",                :string,   :limit => 128,                                 :default => "", :null => false
    t.column "description",         :string,   :limit => 1024,                                :default => "", :null => false
    t.column "experiment_id",       :integer,                  :precision => 11, :scale => 0,                 :null => false
    t.column "protocol_version_id", :integer,                  :precision => 11, :scale => 0,                 :null => false
    t.column "status_id",           :integer,                  :precision => 11, :scale => 0, :default => 0,  :null => false
    t.column "is_milestone",        :boolean,                  :precision => 1,  :scale => 0
    t.column "priority_id",         :integer,                  :precision => 11, :scale => 0
    t.column "started_at",          :datetime
    t.column "ended_at",            :datetime
    t.column "expected_hours",      :decimal
  ...
  create_table "transactions", :force => true do |t|
    ...
    t.column "user_id",         :integer,                  :precision => 11, :scale => 0,                     :null => false
  ...
  create_table "treatment_items", :force => true do |t|
    t.column "treatment_group_id", :integer, :precision => 11, :scale => 0,                 :null => false
    t.column "subject_type",       :string,                                 :default => "", :null => false
    t.column "subject_id",         :integer, :precision => 11, :scale => 0,                 :null => false
    t.column "sequence_order",     :integer, :precision => 11, :scale => 0,                 :null => false
  end
  ...
  create_table "users", :force => true do |t|
    ...
    t.column "state_id",           :integer,                :precision => 11, :scale => 0
    t.column "activated_at",       :datetime
    t.column "token",              :string
    t.column "token_expires_at",   :datetime
    t.column "filter",             :string
    t.column "admin",              :boolean,                :precision => 1,  :scale => 0, :default => false
    t.column "created_at",         :datetime
    t.column "updated_at",         :datetime
